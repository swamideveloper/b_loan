...
public class EPFService_Details_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.epfservice_details);
        ...
        tvDescription.setText(MyApplicationClass.epfService.getDescription());
